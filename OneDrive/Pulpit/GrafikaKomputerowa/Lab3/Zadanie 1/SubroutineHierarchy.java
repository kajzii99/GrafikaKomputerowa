...
public class SubroutineHierarchy extends JPanel {
	...
	private void drawWorld(Graphics2D g2) {
		...
		g2.translate(-3.1,1.45);
		g2.scale(.4,.4);
		rotatingPolygon(g2);
		g2.translate(3.95,-1.2);
		rotatingPolygon(g2);
		g2.setTransform(saveTransform);
		g2.setColor(new Color (0xC900FF));
		g2.translate(-2.3, .1);
		g2.scale(.5, 1.1);
		filledTriangle(g2);
		g2.setColor(Color.RED);
		g2.rotate(Math.toRadians(-8));
		g2.translate(-.14, 1);
		g2.scale(3.5,.15);
		filledRect(g2);
		g2.setTransform(saveTransform);
		...
		g2.scale(.4,.4);
		rotatingPolygon(g2);
		g2.translate(4.2,-1.6);
		rotatingPolygon(g2);
		g2.setTransform(saveTransform);
		g2.setColor(new Color (0x002AFF));
		g2.translate(-0.2, -1.7);
		g2.scale(0.5, 1.3);
		filledTriangle(g2);
		g2.setColor(Color.RED);
		g2.rotate(Math.toRadians(-8));
		...
		g2.translate(1.15,1.75); // jj
		g2.scale(.4,.4);
		rotatingPolygon(g2);
		g2.translate(4.25,-1.2);
		rotatingPolygon(g2);
		g2.setTransform(saveTransform);
		g2.setColor(new Color (0x07FF00));
		g2.translate(2, 0.5); // chuj
		g2.scale(0.5, 1);
		filledTriangle(g2);
		g2.setColor(Color.RED);
		g2.rotate(Math.toRadians(-8));
...
* This method is called before each frame is drawn.
	...
	private void rotatingPolygon(Graphics2D g2) {
		...
		for (int i = 0; i < 19; i++)
			polygon.addPoint((int) (100 * Math.cos(i * 2 * Math.PI / 19)),
					(int) (100 * Math.sin(i * 2 * Math.PI / 19)));
