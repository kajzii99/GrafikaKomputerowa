...
public class SceneGraph extends JPanel {
	...
	private TransformedObject rect1;
	...
	private TransformedObject rect2;
	...
	private TransformedObject rect3;
	...
	private void createWorld() {
		...
		rotatingPolygon1a.setColor(new Color(0,0,0));
		rotatingPolygon1a.setScale(.4,.4).setTranslation(-2.46, 1.95);
		world.add(rotatingPolygon1a);
		rotatingPolygon1b = new TransformedObject(filledPolygon);
		rotatingPolygon1b.setColor(new Color(0,0,0));
		rotatingPolygon1b.setScale(.4,.4).setTranslation(-.58, 1.3);
		world.add(rotatingPolygon1b);
		triangle1 = new TransformedObject(filledTriangle);
		triangle1.setColor(new Color(0x561F8D));
		triangle1.setTranslation(-1.5,.6).setScale(.5,1);
		world.add(triangle1);
		rect1 = new TransformedObject(filledRect);
		rect1.setColor(new Color(0xDB0E3D));
		rect1.setTranslation(-1.5,1.6).setRotation(-20).setScale(2,.1);
		world.add(rect1);

		rotatingPolygon2a = new TransformedObject(filledPolygon);
		rotatingPolygon2a.setColor(new Color(0,0,0));
		rotatingPolygon2a.setScale(.4,.4).setTranslation(-0.05, -0.1);
		world.add(rotatingPolygon2a);
		rotatingPolygon2b = new TransformedObject(filledPolygon);
		rotatingPolygon2b.setColor(new Color(0,0,0));
		rotatingPolygon2b.setScale(.4,.4).setTranslation(1.82, -0.75);
		world.add(rotatingPolygon2b);
		triangle2 = new TransformedObject(filledTriangle);
		triangle2.setColor(new Color(0x001AFF));
		triangle2.setTranslation(0.9,-2.1).setScale(.7,1.6);
		world.add(triangle2);
		rect2 = new TransformedObject(filledRect);
		rect2.setColor(new Color(0xDB0E3D));
		rect2.setTranslation(0.9,-0.45).setRotation(-20).setScale(2.0,.15);
		world.add(rect2);

		rotatingPolygon3a = new TransformedObject(filledPolygon);
		rotatingPolygon3a.setColor(new Color(0,0,0));
		rotatingPolygon3a.setScale(.4,.4).setTranslation(1.45, 2.25);
		world.add(rotatingPolygon3a);
		rotatingPolygon3b = new TransformedObject(filledPolygon);
		rotatingPolygon3b.setColor(new Color(0,0,0));
		rotatingPolygon3b.setScale(.4,.4).setTranslation(3.1, 1.68);
		world.add(rotatingPolygon3b);
		triangle3 = new TransformedObject(filledTriangle);
		triangle3.setColor(new Color(0x36F15F));
		triangle3.setTranslation(2.3,1.06).setScale(.4,.9);
		world.add(triangle3);
		rect3 = new TransformedObject(filledRect);
		rect3.setColor(new Color(0xDB0E3D));
		rect3.setTranslation(2.3,1.95).setRotation(-20).setScale(1.7,.05);
		world.add(rect3);
