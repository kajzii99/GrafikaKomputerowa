...
public class Lab6 extends GLJPanel implements GLEventListener  {
	...
	public void display(GLAutoDrawable drawable) {    
		...
		gl2.glMaterialfv(GL2.GL_FRONT_AND_BACK, GL2.GL_AMBIENT_AND_DIFFUSE, materials[4], 0);
		gl2.glMaterialfv(GL2.GL_FRONT_AND_BACK, GL2.GL_SPECULAR, materials[4], 0);
		gl2.glMaterialfv(GL2.GL_FRONT_AND_BACK, GL2.GL_SHININESS, materials[4], 12);

		gl2.glVertex3d(0, 1, 0);

		gl2.glVertex3d(1.5, -1, 0);
		gl2.glVertex3d(1.41,-1, 0.48);
		gl2.glVertex3d(1.18,-1, 0.92);
		gl2.glVertex3d(0.82,-1, 1.25);
		gl2.glVertex3d(0.36,-1, 1.45);
		gl2.glVertex3d(-0.12,-1, 1.49);
		gl2.glVertex3d(-0.60,-1, 1.37);
		gl2.glVertex3d(-1.01,-1, 1.10);
		gl2.glVertex3d(-1.31,-1, 0.71);
		gl2.glVertex3d(-1.47,-1, 0.24);
		gl2.glVertex3d(-1.47,-1, -0.24);
		gl2.glVertex3d(-1.31,-1, -0.71);
		gl2.glVertex3d(-1.01,-1, -1.10);
		gl2.glVertex3d(-0.60,-1, -1.37);
	...
	public void init(GLAutoDrawable drawable) {
		...
		gl2.glEnable(GL2.GL_DEPTH_TEST);// włączanie swiatla
		gl2.glEnable(GL2.GL_NORMALIZE);
		gl2.glEnable(GL2.GL_LIGHTING);  
		gl2.glEnable(GL2.GL_LIGHT0);
		// TODO configure better lighting!
		float blue1 [] = {0.2f, 0.2f, 0.9f, 1f};
		float blue2 [] = {0.3f, 0.3f, 0.6f, 1f};
		float blue3 [] = {0f, 0f, 0.4f, 1f};
		gl2.glLightfv(GLLightingFunc.GL_LIGHT0, GLLightingFunc.GL_DIFFUSE, FloatBuffer.wrap(blue1));
		gl2.glLightfv(GLLightingFunc.GL_LIGHT0, GLLightingFunc.GL_SPECULAR, FloatBuffer.wrap(blue2));
		gl2.glLightfv(GLLightingFunc.GL_LIGHT0, GLLightingFunc.GL_AMBIENT, FloatBuffer.wrap(blue3));
	}
